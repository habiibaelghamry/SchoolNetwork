...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div class="fl_right">
      <form class="clear" action="SearchSchoolsParent.php" method="post" >
        <fieldset>
          <legend>Search:</legend>
          <input type="text" placeholder="Search Here" name= "searchParent" >
...
<div class="wrapper row2">
  <div class="rounded">
  <nav id="mainav" class="clear"> <?php echo "welcome ".$_SESSION["parent_username"]; ?> </nav>
      <!-- ################################################################################################ -->
  ...
  <div class="rounded">
    <main class="container clear"> 
      ...
      <div class="group btmspace-30"> 
          ...
          <p id="v" ><a href="viewSchoolsParent.php">View All Schools &raquo;</a></p> <!-- DONE -->
          <p id="v" ><a href="ChildApplication.php">Fill Application &raquo;</a></p> <!-- DONE -->
          <p id="v" ><a href="SchoolsThatAccepted.php">Schools That Accepted my Children &raquo;</a></p> <!-- DONE -->
          <p id="v" ><a href="ViewReports.php"> View Reports &raquo;</a></p> <!-- DONE -->
          <p id="v" ><a href="ViewTeachers.php">Teachers &raquo;</a></p>
          <p id="v" ><a href="ViewMySchools.php">My Schools &raquo;</a></p>
          <p id="v" ><a href="MyReviews.php">My Reviews &raquo;</a></p>
