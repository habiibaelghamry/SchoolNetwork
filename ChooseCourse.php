...
<div class="wrapper row22">
  <div class="rounded">
    <nav id="mainav" class="clear">choose course</nav>
  </div>
</div>
...
<?php
  ...
  $host='localhost';
    ...
    $qry = "call ViewCoursesQuestions('$u')";
  ...
  if($result->num_rows > 0)
  {
    while($row = $result->fetch_assoc()) {
      ...
      $r=$r.'<a href="ViewQuestionsTeacher.php?code='.$row['course_code'].'">'.$row['course_code'].'</a>'.'<br>'; 
      $r = $r."<br>";
    }
  }
  else
